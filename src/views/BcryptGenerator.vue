<template>
    <v-container class="bcrypt-generator">
        ...
        <v-row class="ma-2">
            <v-col :cols="6">
                <v-text-field label="Input" variant="outlined" density="compact"
                    hint="Tips: Mathematical operators + - * / are supported" persistent-hint v-model.trim="input"
                    :loading="isEncrypting"></v-text-field>
            </v-col>
            <v-col :cols="4">
                <v-text-field label="Round" variant="outlined" density="compact"
                    v-model.number="encryptRound"></v-text-field>
            </v-col>
        ...
        <v-row class="ma-2">
            <v-col :cols="6">
                <v-text-field label="Output" variant="outlined" density="compact" v-model="output"
                    append-inner-icon="mdi-content-copy" single-line hide-details
                    @click:append-inner="onCopyOutput"></v-text-field>
            </v-col>
        </v-row>
    </v-container>
</template>
